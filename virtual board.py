...
cv.createTrackbar('LH', 'Color Detectors', 110, 179, nothing)
cv.createTrackbar('LS', 'Color Detectors', 50, 255, nothing)
cv.createTrackbar('LV', 'Color Detectors', 50, 255, nothing)
cv.createTrackbar('UH', 'Color Detectors', 130, 179, nothing)
